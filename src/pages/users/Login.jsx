        ...
        <div className='flex lg:grid lg:grid-cols-2 items-center gap-4'>
            <div className='w-full h-full hidden lg:flex relative'>
                ...
                <div className='absolute top-52 right-0 flex items-center flex-col gap-6 text-xl'>
                    <Link to='/login' className='flex font-semibold bg-white text-blue-600 py-3 px-6 rounded-l-3xl'>
                        Sign In
                    </Link>
            ...
            <div className='flex items-center max-lg:border max-lg:rounded-2xl max-sm:m-8 max-lg:m-36 max-lg:py-16 max-sm:py-4 max-lg:shadow-lg max-sm:mt-24 w-full justify-center flex-col gap-2 md:gap-10'>
                ...
                <form action="" className='flex flex-col md:gap-10 gap-4 px-4 w-full md:px-20 '>
                    ...
                    <div className=' text-white max-sm:mt-2 max-sm:text-sm flex flex-col md:flex-row md:items-center justify-between w-full gap-2'>
                        <p className='text-header-600 font-semibold hover:text-blue-600 cursor-pointer'>Forgot Password?</p>
                        <button onClick={handleSubmit} className='bg-blue-600 w-full md:w-fit px-2 py-1 md:px-4 md:py-2 text-lg rounded-2xl font-semibold'>Log In</button>
                    </div>
                </form>
                ...
                <div className='flex items-center flex-col md:gap-2 lg:hidden'>
                    <p className='text-sm md:text-xl text-header-400 font-medium flex items-center md:gap-2 gap-1'>Don't have an account? 
                        <Link to="/register"><span className='text-blue-600 cursor-pointer'>Register</span></Link>
                    </p>
                </div>
            </div>
        </div>
