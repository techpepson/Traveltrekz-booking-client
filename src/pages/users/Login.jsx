    ...
    <div className='h-screen w-screen'>
        ...
        <div className='grid grid-cols-2 items-center gap-4'>
            ...
            <div className='flex items-center justify-center flex-col gap-10'>
                ...
                <form action="" className='flex flex-col gap-10 w-full px-20 '>
                    ...
                    <div className=' text-white flex items-center justify-between w-full'>
                        <p className='text-header-600 font-semibold'>Forgot Password? <span className='text-blue-600 cursor-pointer'>Click here</span></p>
                        <button onClick={handleSubmit} className='bg-blue-600 w-fit px-4 py-2 text-lg  rounded-2xl font-semibold'>Log In</button>
                    </div>
                </form>
