            ...
            <div className='w-full flex flex-col gap-4 text-header-600'>
                ...
                <form action="" className='flex flex-col gap-3'>
                    <div className='flex flex-col gap-1 '>
                        ...
                        <textarea name="" id="" rows={3} className='border w-full rounded-md p-1 outline-none'></textarea>
                    </div>
                    <div className='flex items-center gap-4 w-full'>
                        <div className='flex flex-col gap-1 w-full'>
                            <p className='font-semibold'>Location</p>
                            <input type="text" className='border w-full rounded-md p-1 outline-none'/>
                        </div>
                        <div className='flex flex-col gap-1 w-full'>
                    ...
                    <div className='w-full flex items-center gap-4 justify-end py-6'>
                        ...
                        <button className='bg-blue-600 py-2 px-5 flex items-center justify-center font-semibold text-white rounded-3xl'>Save</button>
                    </div>
                </form>
                <div>
                    ...
                    <div className='flex flex-col gap-2'>
                        ...
                        <input type="password" className='border rounded-md w-full p-1 outline-none'/>
                    </div>
                    <div className='flex items-center justify-between py-4'>
                        <p>Forgotten Password? Click here</p>
                        <button className='bg-blue-600 py-2 px-5 flex items-center justify-center font-semibold text-white rounded-3xl'>Proceed</button>
                    </div>
                </div>
            </div>
        </div>
