    ...
    <>
        ...
        <div className="mx-auto max-sm:mt-10 px-4 md:px-16 pt-8 pb-16">
            ...
            <div className='flex items-center justify-center'>
                <button className="bg-blue-600 text-white px-2 py-1 rounded-md w-fit mt-8 flex items-center gap-1" onClick={loadMoreProperties}><MdKeyboardDoubleArrowDown className="text-3xl" /> See More</button> 
            </div>
        </div>
        <Newsletter />
        <Footer/>
