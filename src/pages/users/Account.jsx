        ...
        <div className='flex flex-col lg:flex-row max-lg:mt-16 p-4 md:p-16 gap-8'>
            ...
            <div className='text-header-600 bg-blue-200 p-5 rounded-md w-full flex gap-2 flex-col'>
                ...
                <div>
                    ...
                    <p>Hi, I’m James, a digital marketer who loves exploring new places and cultures. I enjoy finding unique, comfortable stays for both short trips and extended stays.</p>
                </div>
                <div>
