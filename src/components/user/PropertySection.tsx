...
const PropertySection: React.FC<PropertySectionProps> = ({ properties, scrollRef }) => {
  ...
  return (
    <div className="mb-8">
      <div
        className="flex md:gap-4 overflow-x-auto scrollbar-hide pb-4"
        ref={scrollRef}
      >
            ...
            <div className="relative rounded-lg overflow-hidden">
              ...
              <div
                className={`absolute top-2 right-2 cursor-pointer text-3xl ${
                  favorites[property.id] ? "text-blue-400" : "text-white"
                } p-2 rounded-full`}
              ...
              <div className="absolute bottom-0 left-0 p-2 md:p-4">
                <h3 className="text-white font-medium text-[16px] md:text-lg">
                  {property.title}
                </h3>
                <p className="text-white/80 text-[12px] md:text-sm">
                  {property.location}
                </p>
              </div>
            </div>
