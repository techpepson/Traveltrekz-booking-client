...
const BookingCard = ({amount, handleReserve}) => {
  return (
    <div className='shadow-2xl h-fit w-full p-6 flex justify-center rounded-lg flex-col '>
        ...
        <button onClick={handleReserve} className='bg-blue-600 p-4 rounded-full flex items-center justify-center my-10 text-white font-semibold'>Reserve Now</button>
