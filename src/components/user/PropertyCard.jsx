...
const PropertyCard = ({ images, name, location, range, position, id }) => {
    ...
    return (
        <div className={`bg-white drop-shadow-md w-full overflow-hidden rounded-xl cursor-pointer`} >
            <div className="relative">
                ...
                />
                <div className="absolute top-1/2 left-2 transform -translate-y-1/2 cursor-pointer z-50" onClick={prevImage}>
                ...
                >
                    {favorites[id] ? <MdFavorite /> : <MdFavoriteBorder className='text-white' />}
                </div>
            </div>
