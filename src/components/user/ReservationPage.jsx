...
const ReservationPage = () => {
  ...
  useEffect(() => {
    ...
    const sampleReservations = [
      { id: 1, title: 'City Penthouse', date: new Date(now.getFullYear(), now.getMonth() + 1, 1) },
      { id: 2, title: 'Beach House', date: new Date(now.getFullYear(), now.getMonth() - 1, 1) },
    ];
  ...
  return (
    <Reservation upcomingReservations={upcomingReservations} pastReservations={pastReservations} />
  );
};
